...
export const services = [
  ...
  },
  {
    ...
    tech: ['OpenAI API', 'Pinecone / Qdrant', 'React Components', 'Node.js', 'WhatsApp API'],
    outcomes: ['<1s instant response time for all inquiries', '70% deflection of routine tickets', 'Higher lead conversion rate'],
  },
  {
    icon: Mail,
    ...
    features: [
      ...
      'Domain Warmup & Deliverability Setup',
      'CRM & E-Commerce Synchronization',
    ],
    tech: ['ActiveCampaign', 'Klaviyo', 'HubSpot', 'Mailchimp', 'Brevo', 'SendGrid'],
    outcomes: ['Higher email deliverability & open rates', 'Increased repeat purchase rates', 'Automated revenue generation on autopilot'],
  },
  {
    icon: Globe,
