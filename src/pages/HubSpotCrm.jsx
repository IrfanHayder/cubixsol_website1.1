...
export default function HubSpotCrm() {
  ...
  return (
    <div className="min-h-screen bg-white text-ink selection:bg-orange-500 selection:text-white relative">
      {/* ===================== HERO SECTION ===================== */}
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-28 overflow-hidden bg-gradient-to-b from-orange-50/70 via-white to-white border-b border-orange-100/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            {/* Left Content */}
            <div className="lg:col-span-7">
              <Reveal direction="down" duration={0.6}>
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-100/80 border border-orange-200 text-orange-700 text-xs font-bold tracking-widest uppercase mb-6 shadow-sm">
                  <Zap className="w-3.5 h-3.5 text-orange-600 fill-orange-600 animate-pulse" />
              ...
              <Reveal delay={0.3} duration={0.65}>
                <div className="flex flex-wrap items-center gap-4 mb-10">
                  <motion.button
                    ...
                    className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl font-bold text-white bg-gradient-to-r from-orange-500 via-orange-600 to-amber-600 hover:from-orange-600 hover:to-amber-700 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/35 transition-all duration-300 text-base cursor-pointer"
                  >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    href="#solutions"
                    className="inline-flex items-center gap-2 px-6 py-4 rounded-xl font-semibold text-gray-700 bg-white border border-gray-200 hover:border-orange-300 hover:bg-orange-50/50 hover:text-orange-700 shadow-sm transition-all duration-200 text-base"
                  >
              ...
              <Reveal delay={0.4} duration={0.65}>
                <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-6 border-t border-orange-100/80">
            ...
            <div className="lg:col-span-5 relative">
              <Reveal delay={0.2} direction="left" duration={0.7} scale>
                <div className="relative rounded-3xl p-6 bg-gradient-to-br from-orange-500/10 via-orange-50 to-amber-50/40 border border-orange-200/80 shadow-2xl shadow-orange-500/10 backdrop-blur-sm">
                  <div className="relative rounded-2xl overflow-hidden shadow-inner bg-slate-900 border border-slate-800">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent flex flex-col justify-end p-6">
                      <div className="flex items-center justify-between">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-orange-600/90 text-white text-xs font-bold backdrop-blur-md">
                  ...
                  <motion.div
                    ...
                    className="absolute -top-4 -right-4 bg-white rounded-2xl p-3 shadow-xl border border-orange-100 hidden sm:flex items-center gap-2 text-xs font-bold text-ink"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-4 -left-4 bg-white rounded-2xl p-3 shadow-xl border border-orange-100 hidden sm:flex items-center gap-2 text-xs font-bold text-ink"
                  >
                    <div className="w-8 h-8 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center font-extrabold">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.problemEyebrow}</p>
            ...
            {data.problemCards?.map((card, idx) => (
              <StaggerItem key={idx}>
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-6 sm:p-7 border border-gray-100 shadow-sm hover:shadow-md hover:border-orange-200 transition-all duration-300 h-full flex flex-col justify-between"
                >
                  <div>
      ...
      <section id="solutions" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.capabilitiesEyebrow}</p>
            ...
            {data.capabilitiesCards?.map((item, idx) => (
              <StaggerItem key={idx}>
                <motion.div
                  ...
                  className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-card hover:shadow-soft hover:border-orange-200 transition-all duration-300 flex flex-col h-full group"
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="text-xl font-bold text-ink mb-2.5 group-hover:text-orange-600 transition-colors">
                        {item.title}
                      </h3>
      ...
      {/* ===================== SECTION 3: FIND YOUR RIGHT HUBSPOT AUTOMATION PATH ===================== */}
      <section className="py-20 bg-gradient-to-b from-gray-50/80 via-orange-50/30 to-gray-50/80 border-y border-gray-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            {/* Left Graphic & Header */}
            <div className="lg:col-span-5">
              <Reveal direction="right" duration={0.65}>
                <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.fixFirstEyebrow}</p>
                <h2 className="text-3xl sm:text-4xl font-extrabold text-ink leading-tight mb-4">
                  {data.fixFirstTitle}
                </h2>
                ...
                <div className="relative rounded-2xl overflow-hidden border border-orange-100 shadow-md bg-white p-3">
                  <img
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-xs font-bold text-orange-600 uppercase tracking-wide">Selected Blueprint</p>
                  ...
                  <Reveal key={item.id} delay={idx * 0.08} duration={0.5}>
                    <motion.div
                      ...
                      className={`cursor-pointer rounded-2xl p-6 transition-all duration-300 border ${
                        isSelected
                          ? 'bg-white border-orange-500 shadow-lg ring-2 ring-orange-500/20 translate-x-1'
                          : 'bg-white/80 border-gray-200 hover:border-orange-200 hover:bg-white'
                      }`}
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <div className="flex items-center gap-2.5 mb-2">
                            ...
                            <h3 className={`font-bold text-base sm:text-lg ${isSelected ? 'text-orange-700' : 'text-ink'}`}>
                              {item.title}
                            </h3>
                          </div>
                        ...
                        <div className="shrink-0 mt-1">
                          <div
                            className={`w-6 h-6 rounded-full flex items-center justify-center border transition ${
                              isSelected ? 'bg-orange-600 border-orange-600 text-white' : 'border-gray-300 text-transparent'
                            }`}
                          >
                            <CheckCircle2 className="w-4 h-4" />
                          </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <Reveal direction="right" duration={0.65}>
                <div className="rounded-3xl p-8 sm:p-10 bg-gradient-to-br from-slate-900 via-slate-900 to-amber-950 text-white shadow-2xl relative overflow-hidden border border-slate-800">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-orange-400 mb-3">{data.processEyebrow}</p>
                  ...
                  <motion.button
                    ...
                    className="w-full py-3.5 px-6 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-bold text-sm inline-flex items-center justify-center gap-2 shadow-lg shadow-orange-600/30 transition-all duration-200 cursor-pointer"
                  >
              ...
              {data.processSteps?.map((step, idx) => (
                <Reveal key={idx} delay={idx * 0.08} duration={0.5}>
                  <motion.div
                    ...
                    className="flex items-start gap-5 p-5 rounded-2xl bg-gray-50/70 border border-gray-100 hover:bg-white hover:border-orange-200 hover:shadow-sm transition-all duration-200"
                  >
                    <span className="shrink-0 w-11 h-11 rounded-xl bg-orange-100 text-orange-700 font-extrabold flex items-center justify-center text-base border border-orange-200">
                      {step.step}
                    </span>
                    <div>
      ...
      {/* ===================== SECTION 5: WAYS TO WORK WITH OUR TEAM (3 MODELS) ===================== */}
      <section className="py-24 bg-gradient-to-b from-white via-orange-50/25 to-white border-y border-orange-100/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.modelsEyebrow}</p>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-ink leading-tight mb-4">
                {data.modelsTitle}
              </h2>
              <p className="text-base sm:text-lg text-gray-500 leading-relaxed">
              ...
              <StaggerItem key={idx}>
                <motion.div
                  ...
                  className={`rounded-3xl p-8 border flex flex-col justify-between h-full relative transition-all duration-300 ${
                    model.isPopular
                      ? 'bg-white border-orange-500 shadow-xl ring-2 ring-orange-500/20 -translate-y-2'
                      : 'bg-white border-gray-200/90 shadow-card hover:shadow-soft hover:border-orange-200'
                  }`}
                >
                  {model.isPopular && (
                    <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                      <span className="bg-orange-600 text-white text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full shadow-md">
                        Most Popular
                      </span>
                    </div>
                  )}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <span className="w-10 h-10 rounded-xl bg-orange-50 border border-orange-100 text-orange-600 font-extrabold text-lg flex items-center justify-center">
                        {model.number}
                      </span>
                    </div>
                  ...
                  <motion.button
                    ...
                    className={`w-full py-3.5 rounded-xl font-bold text-sm transition-all duration-200 cursor-pointer ${
                      model.isPopular
                        ? 'bg-orange-600 text-white hover:bg-orange-700 shadow-md shadow-orange-600/25'
                        : 'bg-gray-100 text-ink hover:bg-orange-50 hover:text-orange-700'
                    }`}
                  >
      ...
      <section className="py-24 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.spectrumEyebrow}</p>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-ink leading-tight mb-4">
                {data.spectrumTitle}
              </h2>
              <p className="text-base sm:text-lg text-gray-500 leading-relaxed">
            ...
            {data.integrations?.map((item, idx) => (
              <StaggerItem key={idx}>
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white via-orange-50/30 to-white rounded-2xl p-6 border border-gray-200/80 shadow-sm hover:shadow-md hover:border-orange-300 transition-all duration-300 flex flex-col justify-between h-full group"
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-12 h-12 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-center text-orange-600 group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300">
                    ...
                    <h3 className="font-bold text-lg text-ink mb-2 group-hover:text-orange-600 transition-colors">
                      {item.name}
                    </h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-100 flex items-center gap-1.5 text-xs font-semibold text-orange-600">
      ...
      <section id="case-studies" className="py-24 bg-gray-50/70 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">{data.outcomesEyebrow}</p>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-ink leading-tight mb-4">
                {data.outcomesTitle}
              </h2>
              <p className="text-base sm:text-lg text-gray-500 leading-relaxed">
          ...
          <Stagger className="grid md:grid-cols-3 gap-8" staggerDelay={0.08}>
            {data.outcomeCards?.map((card, idx) => (
              <StaggerItem key={idx}>
                <motion.div
                  whileHover={{ y: -8, transition: { duration: 0.25 } }}
                  className="bg-white rounded-3xl overflow-hidden border border-gray-200/80 shadow-card hover:shadow-soft hover:border-orange-200 transition-all duration-300 flex flex-col h-full"
                >
                  ...
                  <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="mb-4 flex items-baseline gap-2">
                        <span className="text-3xl font-extrabold text-orange-600">{card.metric}</span>
                    ...
                    <div className="mt-6 pt-4">
                      <button
                        ...
                        className="w-full py-2.5 rounded-xl border border-orange-200 text-orange-600 font-bold text-xs hover:bg-orange-50 transition cursor-pointer"
                      >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <Reveal direction="up" duration={0.6}>
              <p className="text-xs font-bold tracking-widest uppercase text-orange-600 mb-3">FAQ</p>
