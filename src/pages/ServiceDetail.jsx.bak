...
export default function ServiceDetail() {
  ...
  const scrollToForm = (e) => {
    e.preventDefault();
    document.getElementById(isAppJourney ? 'app-journey' : 'service-inquiry')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  };
  ...
  return (
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <Reveal direction="right" scale>
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className={`w-12 h-12 rounded-xl flex items-center justify-center ${service.color}`}>
            ...
            <div className="flex flex-wrap gap-3">
              <a href={isAppJourney ? "#app-journey" : "#service-inquiry"} onClick={scrollToForm} className="btn-primary">
            ...
            <div className="mt-6 flex flex-wrap gap-2.5 max-w-xl">
              ...
              >
                <span className="w-8 h-8 rounded-lg bg-gradient-to-b from-[#4b8bff] to-[#1a56db] flex flex-col items-center justify-center text-white shrink-0">
                  ...
                  <span className="text-[4px] font-bold bg-orange-500 px-0.5 rounded-[1px] mt-0.5">P</span>
                </span>
                <span className="text-left">
                  <span className="block text-[11px] font-bold text-ink leading-tight">GoodFirms</span>
          ...
          <Reveal direction="left" delay={0.1}>
            <div className="relative">
              <div
                className={`absolute -inset-3 rounded-[1.75rem] bg-gradient-to-br ${service.gradient} opacity-20 blur-2xl`}
              />
              <div className="relative rounded-3xl overflow-hidden shadow-elev aspect-[4/3] bg-gray-100">
                {service.heroImage ? (
                  ...
                  >
                    <Icon className="w-28 h-28 text-white/90" strokeWidth={1.25} />
                  </div>
                )}
      ...
      {/*
        CONTENT + TOC parent — ends BEFORE form/footer.
        Pure CSS sticky: TOC sticks while this parent is on screen,
        then scrolls away with the last content (Arbisoft behaviour).
      */}
      ...
      {/* App journey wizard for Mobile / iOS / Android */}
      {isAppJourney && (
      ...
      {/* Simple inquiry for other services */}
      {!isAppJourney && (
