...
const initialServices = [
  ...
  {
    "seo": {
      "metaTitle": "Data Migration Services | Cubixsol",
      "metaDescription": "Cubixsol handles software, website, application & database migrations with minimal downtime and clear validation. Safe, tested data migration. Free consultation.\n",
      "keywords": "",
      "ogTitle": "",
      "ogDescription": "",
    ...
    "icon": "/uploads/media-1788761191368-367855789.svg",
    "slug": "data-migration",
    ...
    "techTitle": "Technologies We Use",
    "businessTypesItems": [],
    "ctaBannerButtonText": "Start Your Data Migration Project",
    "ctaBannerDesc": "Move your business data with reliable data migration services from Cubixsol. Tell us about your current systems and migration requirements, and our team will help you plan the next steps.\n",
    "ctaBannerEyebrow": "",
    ...
    "serviceProcessSteps": [
      {
        "stepNumber": "01",
        "title": "Discover",
        "desc": "We begin by reviewing your current systems, databases, applications, data sources, integrations, and migration goals. Early discovery helps identify dependencies, data quality issues, technical limits, and possible risks.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "02",
        "title": "Plan",
        "desc": "Our team defines the migration method, data mapping, transfer process, testing requirements, milestones, and rollback options. A clear plan gives your team a better view of the work before development begins.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "03",
        "title": "Build",
        "desc": "We prepare the migration environment and create the processes needed to move your data. Data can be cleaned, converted, mapped, or structured before the transfer where required.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "04",
        "title": "Test",
        "desc": "We test the migration to check data accuracy, completeness, system functions, integrations, and important business processes. Any issues found during testing are reviewed and fixed before launch.",
        "image": "",
        "points": []
      },
      {
        ...
        "desc": "Once testing is complete, we move the data to the target environment and check the results after launch. Ongoing support can help resolve technical issues and keep the new environment working properly.",
        "image": "",
        "points": []
      }
    ],
    ...
    "serviceProcessText": "01 | Discover | We begin by reviewing your current systems, databases, applications, data sources, integrations, and migration goals. Early discovery helps identify dependencies, data quality issues, technical limits, and possible risks.\n\n02 | Plan | Our team defines the migration method, data mapping, transfer process, testing requirements, milestones, and rollback options. A clear plan gives your team a better view of the work before development begins.\n\n03 | Build | We prepare the migration environment and create the processes needed to move your data. Data can be cleaned, converted, mapped, or structured before the transfer where required.\n\n04 | Test | We test the migration to check data accuracy, completeness, system functions, integrations, and important business processes. Any issues found during testing are reviewed and fixed before launch.\n\n05 | Launch & Support | Once testing is complete, we move the data to the target environment and check the results after launch. Ongoing support can help resolve technical issues and keep the new environment working properly.",
    "serviceProcessTitle": "Our Data Migration Process",
    "subServicesIntro": "Our data migration team helps businesses move data between databases, applications, websites, servers, and cloud environments. Each project starts with a review of your current systems, data structure, technical requirements, and target environment.\n\nWe identify data dependencies, quality issues, system connections, and possible risks before the migration begins. Careful planning and testing help reduce errors, data loss, and disruption during the move.\n",
    "subServicesText": "Our Data Migration Services | Our team supports different types of data migration, from individual databases and websites to projects involving several systems. Each service covers the technical work needed to move and check your data in the new environment.\n\nDatabase Migration Services | We move databases between servers, platforms, and environments while keeping business data accurate and accessible. Our team reviews the existing database, prepares the data, manages the transfer, and checks the new environment. Database migration can involve schema changes, data conversion, compatibility checks, and connections with other systems. We review these requirements before the migration starts.\n\nCloud Migration Services | We help businesses move data and workloads to cloud platforms based on their technical and business requirements. Our team reviews data volume, security needs, application connections, infrastructure, and business operations before planning the move. Cloud migration can also involve moving data from older or on-premises systems. We manage the required transfer, testing, and validation stages before the new environment is put into use.\n\nApp & Website Migration | We migrate application and website data when a business moves to a new platform, hosting environment, or technology stack. The work can include user records, website content, databases, settings, and other important information. Our team checks the new environment before launch to find missing data, broken connections, configuration problems, or other issues that may affect the application or website.\n\nSEO Migration | Website changes can affect search rankings when URLs, page structures, domains, or platforms change. Our SEO migration service helps keep important search elements in place during the move. We can manage URL mapping, redirects, metadata checks, content reviews, and other technical checks needed during a website migration. These steps help reduce avoidable traffic and ranking problems.\n\nData Validation & Testing | Moving data is only one part of a successful migration. Our team checks whether the transferred data is complete, accurate, and usable in the new environment. We compare records, test important functions, review system connections, and look for missing, duplicated, damaged, or incorrectly mapped data. Testing helps confirm that the new system is ready for normal business use.",
    "subServicesTitle": "Data Migration Services for Your Business",
    "whyChooseIntro": "",
  ...
  },
  {
    "seo": {
      ...
      "metaDescription": "SEO, PPC, and social strategies that increase visibility and generate quality leads.",
      "keywords": "GA4, Search Console, Meta Ads, Google Ads, HubSpot",
      "ogTitle": "Digital Marketing Services | Cubixsol",
      "ogDescription": "SEO, PPC, and social strategies that increase visibility and generate quality leads.",
      "ogImage": "https://images.unsplash.com/photo-1432888622747-4eb9a8f2c1c9?auto=format&fit=crop&w=1000&h=750&q=70",
      "canonicalUrl": ""
    },
    "icon": "/uploads/media-1788760355439-537523465.svg",
    ...
    "serviceProcessSteps": [
      {
        "stepNumber": "01",
        "title": "Audit",
        "desc": "We review your website, analytics, campaigns, competitors, audience, and current conversion path to identify gaps and opportunities.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "02",
        "title": "Strategy",
        "desc": "The findings become a prioritized channel plan with clear goals, target audiences, messaging, budgets, and performance indicators.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "03",
        "title": "Execute",
        "desc": "Our team launches and manages the agreed campaigns, content, optimization work, and tracking setup.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "04",
        "title": "Report",
        "desc": "Regular reports connect marketing activity with meaningful measures such as qualified traffic, leads, sales, acquisition cost, and return on investment.",
        "image": "",
        "points": []
      },
      {
        "stepNumber": "05",
        "title": "Optimize",
        "desc": "We test, learn, and adjust campaigns based on performance data, market changes, and new business priorities.",
        "image": "",
        "points": []
      }
    ],
    ...
    "faqsText": "How much do digital marketing services cost? | Cost depends on the channels, market competition, campaign scope, advertising budget, and level of support required. After the initial audit, Cubixsol recommends a practical scope and explains the cost before work begins.\n\nHow long does digital marketing take to produce results? | Paid campaigns may start generating traffic and leads soon after launch, while SEO and content usually need more time to build momentum. Timelines also depend on your starting position, competition, budget, and offer.\n\nShould I invest in SEO or PPC? | SEO supports long-term organic visibility, while PPC can capture demand more quickly. Many businesses benefit from using both: paid campaigns create immediate reach while SEO develops a sustainable acquisition channel.\n\nWhat reporting will I receive? | Reports focus on the metrics connected to your goals, including qualified traffic, conversions, lead quality, acquisition cost, sales, and return on investment. We also explain what changed and what happens next.\n\nDo you require long-term contracts? | Engagement terms depend on the selected services and campaign needs. We define the scope, deliverables, reporting schedule, and contract terms upfront so you can make an informed decision.",
    "serviceProcessText": "01 | Audit | We review your website, analytics, campaigns, competitors, audience, and current conversion path to identify gaps and opportunities.\n\n02 | Strategy | The findings become a prioritized channel plan with clear goals, target audiences, messaging, budgets, and performance indicators.\n\n03 | Execute | Our team launches and manages the agreed campaigns, content, optimization work, and tracking setup.\n\n04 | Report | Regular reports connect marketing activity with meaningful measures such as qualified traffic, leads, sales, acquisition cost, and return on investment.\n\n05 | Optimize | We test, learn, and adjust campaigns based on performance data, market changes, and new business priorities.",
    "subServicesText": "Search Engine Optimization | Our digital marketing and SEO services include technical audits, keyword strategy, on-page optimization, content planning, internal linking, and performance tracking. These digital marketing SEO services focus on sustainable traffic and qualified inquiries rather than rankings with little commercial value.\n\nPPC and Google Ads | Reach high-intent prospects through carefully structured paid search and display campaigns. We manage targeting, ad copy, landing-page alignment, conversion tracking, bid strategy, and ongoing testing to reduce wasted spend and improve return on ad investment.\n\nSocial Media Marketing | We build a consistent presence on the platforms your audience actually uses. Our team plans content, manages publishing, supports paid social campaigns, and reviews engagement data to strengthen awareness and create demand.\n\nContent Marketing | Give potential customers useful answers at every stage of their journey. We develop content strategies for service pages, landing pages, blogs, lead magnets, and campaign assets that support search visibility, authority, and conversions.\n\nEmail Marketing | We help businesses re-engage subscribers and past customers to encourage repeat purchases.  We create segmented campaigns, automated sequences, promotional emails, and retention flows designed around the actions you want recipients to take.\n\nLocal SEO | Our local digital marketing services cover location targeting, Google Business Profile optimization, local landing pages, citation consistency, reviews, and local search reporting. Businesses comparing digital marketing services near me can assess our approach through a focused audit and clear campaign plan. For organizations seeking DC digital marketing services, we develop campaigns based on local audience behavior and market demand.",
    "whyChooseText": "**Results-focused strategies:** | Every recommendation supports a defined traffic, lead, sales, or retention goal.\n\n**Transparent communication:** | You receive clear updates on completed work, campaign performance, and next priorities.\n\n**A dedicated team:** | Specialists across search, paid media, content, social, and analytics work toward the same objectives.\n\n**ROI-focused decisions: ** | Budget shifts and campaign changes are guided by evidence, not assumptions or vanity metrics.",
    ...
    "subServicesIntro": "Every channel should support a defined business goal. We assess your audience, market, current performance, and sales process before recommending where to invest.",
    "subServicesTitle": "Our Digital Marketing Services",
    "serviceProcessTitle": "Our Marketing Process",
    "whyChooseTitle": "Why Choose Cubixsol?",
    "ctaBannerButtonText": "Get a Free Marketing Audit",
    "ctaBannerDesc": "Build a clearer path from online visibility to qualified leads and revenue. Choose Cubixsol’s **digital marketing services** and start with a practical review of your performance.",
    "ctaBannerTitle": "Ready to Grow Your Traffic & Revenue?",
    "whyChooseImage": "Why Choose Cubixsol?",
    "whyChooseIntro": "Our **best digital marketing services** create accountability between marketing activity and business outcomes. Cubixsol gives you:",
  ...
  },
  {
    "seo": {
      ...
      "ogTitle": "E-Commerce Development Services | Cubixsol",
      "ogDescription": "Launch or improve an online store, marketplace, or subscription platform built around easier product discovery and checkout. We support secure payments, inventory systems, third-party integrations, mobile optimization, and simple store management.",
      "ogImage": "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1000&h=750&q=70",
      "canonicalUrl": ""
    },
    "icon": "/uploads/media-1788761191368-374799161.svg",
    "slug": "ecommerce-solutions",
    "heroImage": "/uploads/media-1788439771571-862411230.svg",
    "title": "High-Converting Ecommerce Development Services for Consistent Growth",
    "desc": "At Cubixsol, we offer ecommerce development services for businesses ready to launch or scale their online sales channels. We build fast, easy-to-manage commerce platforms to connect your customers with your products, payments, orders, and business operations.",
    ...
    "faqs": [
      {
        ...
        "a": "We evaluate your catalog size, customization needs, and budget to recommend Shopify, WooCommerce, Next.js headless commerce, or custom Laravel."
      },
      {
        "q": "Can you migrate my store from another platform?",
        "a": "Yes, we safely migrate products, customer accounts, order history, and SEO redirects with zero data loss and minimal downtime."
      },
      {
        "q": "How do you ensure checkout security?",
        "a": "We implement SSL encryption, PCI-DSS compliant payment gateways, fraud detection, and tokenized transactions."
      },
      {
        "q": "Can you integrate with our inventory and ERP systems?",
        "a": "Yes, we build real-time two-way API integrations with ERPs (SAP, NetSuite), CRMs (HubSpot, Salesforce), and 3PL shipping providers."
      },
      {
        "q": "Do you offer ongoing store maintenance and CRO?",
        "a": "Yes, we provide ongoing speed optimization, security patches, conversion rate optimization (CRO), and promotional feature rollouts."
      }
    ],
    "techDesc": "We select technologies according to the project’s functionality, performance requirements, integrations, and future roadmap.\n\nThe goal is not to use the newest technology for its own sake. It is to choose a dependable stack that fits your product, supports maintainability, and avoids unnecessary technical complexity.",
    "techTitle": "Technologies We Use",
    "additionalParagraph": "Our e-commerce solutions cover the planning, design, development, integration, testing, and ongoing support of online stores, mobile commerce apps, B2B portals, and multi-vendor marketplaces. We shape every solution around your customers, catalog, pricing model, internal workflows, and technology environment. Whether you need a new storefront or a replacement for an outdated system, we build a practical platform that supports both the buying experience and the teams managing it.",
    "businessTypesItems": [],
    "businessTypesText": "",
    "ctaPrimaryText": "Start Your E-Commerce Project",
    "ctaSecondaryText": "Get a Free Estimate",
    "faqsText": "Which ecommerce platform is best for my business? | We evaluate your catalog size, customization needs, and budget to recommend Shopify, WooCommerce, Next.js headless commerce, or custom Laravel.\nCan you migrate my store from another platform? | Yes, we safely migrate products, customer accounts, order history, and SEO redirects with zero data loss and minimal downtime.\nHow do you ensure checkout security? | We implement SSL encryption, PCI-DSS compliant payment gateways, fraud detection, and tokenized transactions.\nCan you integrate with our inventory and ERP systems? | Yes, we build real-time two-way API integrations with ERPs (SAP, NetSuite), CRMs (HubSpot, Salesforce), and 3PL shipping providers.\nDo you offer ongoing store maintenance and CRO? | Yes, we provide ongoing speed optimization, security patches, conversion rate optimization (CRO), and promotional feature rollouts.",
    "heroSubtitle": "",
    "serviceProcessSteps": [
      {
        "points": [],
        ...
        "desc": "Requirements gathering, catalog structuring, checkout flow planning, and platform selection."
      },
      {
        "points": [],
        "stepNumber": "02",
        "title": "UI/UX & Storefront Design",
        "desc": "Mobile-first shopping experience, product discovery, and brand-tailored layouts."
      },
      {
        "points": [],
        "stepNumber": "03",
        "title": "Custom Development & Integrations",
        "desc": "Storefront coding, payment gateway setup, inventory sync, and custom app features."
      },
      {
        "points": [],
        "stepNumber": "04",
        "title": "Testing & QA",
        "desc": "Checkout testing, security audit, speed optimization, and cross-browser quality assurance."
      },
      {
        "points": [],
        "stepNumber": "05",
        "title": "Launch & Growth Optimization",
        "desc": "Go-live execution, analytics tracking setup, and post-launch conversion rate monitoring."
      }
    ],
    "serviceProcessText": "01 | Store Strategy & Architecture | Requirements gathering, catalog structuring, checkout flow planning, and platform selection.\n02 | UI/UX & Storefront Design | Mobile-first shopping experience, product discovery, and brand-tailored layouts.\n03 | Custom Development & Integrations | Storefront coding, payment gateway setup, inventory sync, and custom app features.\n04 | Testing & QA | Checkout testing, security audit, speed optimization, and cross-browser quality assurance.\n05 | Launch & Growth Optimization | Go-live execution, analytics tracking setup, and post-launch conversion rate monitoring.",
    "subServicesIntro": "We develop high-performing storefronts and streamlined systems behind them, giving businesses one coordinated team from early planning through launch and ongoing improvement. ",
    "subServicesItems": [
      {
        "title": "Custom E-Commerce Stores",
        "desc": "Our e-commerce web development services create responsive stores around their specific products, customers, and operational requirements. We develop intuitive navigation, product search, account features, streamlined checkout, administrative controls, and custom workflows without forcing the business into a rigid template."
      },
      {
        "title": "Shopify Development",
        "desc": "Our Shopify development services cover new store builds, theme customization, feature development, platform migration, app integration, and performance improvements. We configure Shopify around your catalog and buying journey while keeping daily product, content, promotion, and order management straightforward for your team."
      },
      {
        "title": "B2B Commerce Platforms",
        "desc": "Our b2b ecommerce development services support manufacturers, wholesalers, distributors, and other companies with complex business buying processes. Capabilities can include customer-specific catalogs, contract pricing, bulk ordering, quote requests, approval workflows, repeat purchases, account roles, and ERP or inventory integration."
      },
      {
        "title": "E-Commerce Mobile Apps",
        "desc": "Our e-commerce app development services give customers a convenient way to browse and buy on mobile devices. Depending on the project, apps can include account access, product discovery, wish lists, secure checkout, order tracking, notifications, loyalty features, and synchronized product and inventory data."
      },
      {
        "title": "Multi-Vendor Marketplaces",
        "desc": "We build marketplace platforms that connect buyers with multiple vendors through one digital experience. Features can include vendor onboarding, catalog management, commissions, seller dashboards, order routing, payment distribution, reviews, reporting, and role-based controls. The architecture reflects the marketplace model rather than relying on unnecessary features."
      }
    ],
    "subServicesText": "Custom E-Commerce Stores | Our e-commerce web development services create responsive stores around their specific products, customers, and operational requirements. We develop intuitive navigation, product search, account features, streamlined checkout, administrative controls, and custom workflows without forcing the business into a rigid template.\nShopify Development | Our Shopify development services cover new store builds, theme customization, feature development, platform migration, app integration, and performance improvements. We configure Shopify around your catalog and buying journey while keeping daily product, content, promotion, and order management straightforward for your team.\nB2B Commerce Platforms | Our b2b ecommerce development services support manufacturers, wholesalers, distributors, and other companies with complex business buying processes. Capabilities can include customer-specific catalogs, contract pricing, bulk ordering, quote requests, approval workflows, repeat purchases, account roles, and ERP or inventory integration.\nE-Commerce Mobile Apps | Our e-commerce app development services give customers a convenient way to browse and buy on mobile devices. Depending on the project, apps can include account access, product discovery, wish lists, secure checkout, order tracking, notifications, loyalty features, and synchronized product and inventory data.\nMulti-Vendor Marketplaces | We build marketplace platforms that connect buyers with multiple vendors through one digital experience. Features can include vendor onboarding, catalog management, commissions, seller dashboards, order routing, payment distribution, reviews, reporting, and role-based controls. The architecture reflects the marketplace model rather than relying on unnecessary features.",
    "subServicesTitle": "Our E-Commerce Solutions and Services",
    "whyChooseItems": [
      {
        "title": "Conversion-Optimized Architecture",
        "desc": "Fast page speeds, frictionless mobile checkout, and high-converting product pages."
      },
      {
        "title": "Scalable Catalog & Inventory Sync",
        "desc": "Engineered to handle high traffic spikes, flash sales, and complex multi-warehouse inventory."
      },
      {
        "title": "Secure Multi-Gateway Payments",
        "desc": "Seamless integration with Stripe, PayPal, Apple Pay, Klarna, and local payment providers."
      },
      {
        "title": "Omnichannel Integration",
        "desc": "Connect storefronts with ERP, CRM, marketing automation, and 3PL shipping carriers."
      }
    ],
    "whyChooseText": "Conversion-Optimized Architecture | Fast page speeds, frictionless mobile checkout, and high-converting product pages.\nScalable Catalog & Inventory Sync | Engineered to handle high traffic spikes, flash sales, and complex multi-warehouse inventory.\nSecure Multi-Gateway Payments | Seamless integration with Stripe, PayPal, Apple Pay, Klarna, and local payment providers.\nOmnichannel Integration | Connect storefronts with ERP, CRM, marketing automation, and 3PL shipping carriers.",
    "menuTitle": "E-commerce Solutions",
    "serviceProcessTitle": "Our E-Commerce Development Process",
    "whyChooseIntro": "We build scalable, high-converting digital storefronts that turn casual visitors into loyal repeat customers.",
    "whyChooseTitle": "Why Choose Cubixsol for E-Commerce Development?",
    "ctaBannerButtonText": "Start Your E-Commerce Store",
  ...
  {
    "seo": {
      "metaTitle": "UI/UX Design Services | Cubixsol",
      "metaDescription": "Give users a clear and enjoyable path through your product. Our UI/UX specialists turn research and business requirements into user flows, wireframes, interactive prototypes, accessible interfaces, and consistent design systems.",
      "keywords": "Figma, FigJam, Principle, Storybook",
      "ogTitle": "UI/UX Design Services | Cubixsol",
      "ogDescription": "Give users a clear and enjoyable path through your product. Our UI/UX specialists turn research and business requirements into user flows, wireframes, interactive prototypes, accessible interfaces, and consistent design systems.",
      "ogImage": "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?auto=format&fit=crop&w=1000&h=750&q=70",
      "canonicalUrl": ""
    },
    "icon": "/uploads/media-1788761191369-156079565.svg",
    ...
    "faqs": [
      {
        ...
        "a": "The cost depends on the product type, number of screens, design complexity, research needs, and project scope. A simple website usually requires less design work than a large web application or mobile app with multiple user flows. We review your requirements before providing an estimate.",
        "title": "How much do UI/UX design services cost?",
        "desc": "The cost depends on the product type, number of screens, design complexity, research needs, and project scope. A simple website usually requires less design work than a large web application or mobile app with multiple user flows. We review your requirements before providing an estimate."
      },
      {
        "q": "What is the UI/UX design process?",
        "a": "Our process includes five main stages: Discover, Plan, Build, Test, and Launch and Support. The work included in each stage depends on your product, existing designs, features, and project requirements.",
        "title": "What is the UI/UX design process?",
        "desc": "Our process includes five main stages: Discover, Plan, Build, Test, and Launch and Support. The work included in each stage depends on your product, existing designs, features, and project requirements."
      },
      {
        "q": "What is the difference between UI/UX design and development?",
        "a": "UX design covers how users move through a product and complete tasks. UI design covers the visual parts of the interface, such as layouts, buttons, forms, and other elements. Development turns the approved design into a working website, app, or digital product.",
        "title": "What is the difference between UI/UX design and development?",
        "desc": "UX design covers how users move through a product and complete tasks. UI design covers the visual parts of the interface, such as layouts, buttons, forms, and other elements. Development turns the approved design into a working website, app, or digital product."
      },
      {
        "q": "How many design revisions do you offer?",
        "a": "Revision rounds depend on the project scope and service agreed at the start. We discuss the revision process before work begins so you know what is included in your project.",
        "title": "How many design revisions do you offer?",
        "desc": "Revision rounds depend on the project scope and service agreed at the start. We discuss the revision process before work begins so you know what is included in your project."
      },
      {
        "q": "What will I receive when the project is complete?",
        "a": "Your deliverables depend on the work agreed for the project. They may include user flows, wireframes, UI designs, clickable prototypes, design system components, and final design files for development. We confirm the final deliverables before the project begins.",
        "title": "What will I receive when the project is complete?",
        "desc": "Your deliverables depend on the work agreed for the project. They may include user flows, wireframes, UI designs, clickable prototypes, design system components, and final design files for development. We confirm the final deliverables before the project begins."
      }
    ],
    "techDesc": "Our UI/UX design toolkit includes Figma, Adobe XD, and Sketch. We choose tools based on the project requirements, design work, and how your team plans to review and use the files.\n\nWe also use usability testing to review important screens and user flows when testing is required for the project.",
    "techTitle": "Technologies We Use",
    "businessTypesItems": [],
    "ctaBannerButtonText": "Start Your Project",
    "ctaBannerDesc": "Need a new interface, a better user flow, or a complete product design? Cubixsol provides **ui ux design** services for websites, apps, and digital products. Share your requirements with our team, and we can help define the right design approac",
    "ctaBannerEyebrow": "",
    "ctaBannerTitle": "Ready to Start Your Project?",
    "serviceProcessSteps": [],
    "subServicesItems": [
      {
        "title": "UI Design",
        "desc": "We design the visual parts of your product, including layouts, buttons, menus, forms, typography, and other interface elements. Each screen is planned around the information users need and the actions they need to take. Our team also keeps common elements consistent across screens so users can move through the product more easily.",
        "q": "UI Design",
        "a": "We design the visual parts of your product, including layouts, buttons, menus, forms, typography, and other interface elements. Each screen is planned around the information users need and the actions they need to take. Our team also keeps common elements consistent across screens so users can move through the product more easily."
      },
      {
        "title": "UX Research",
        "desc": "We review your users, business goals, product requirements, and existing user experience before detailed design begins. Research can help identify confusing steps, missing information, and problems in the current user flow. Our findings help shape the structure of the product and guide later design decisions.",
        "q": "UX Research",
        "a": "We review your users, business goals, product requirements, and existing user experience before detailed design begins. Research can help identify confusing steps, missing information, and problems in the current user flow. Our findings help shape the structure of the product and guide later design decisions."
      },
      {
        "title": "Web App Design",
        "desc": "We design web applications such as SaaS platforms, dashboards, customer portals, and business tools. Our team plans the navigation, layouts, forms, tables, and other screens around the tasks users need to complete. Each part of the interface is organized to help users find information and complete actions without unnecessary steps.",
        "q": "Web App Design",
        "a": "We design web applications such as SaaS platforms, dashboards, customer portals, and business tools. Our team plans the navigation, layouts, forms, tables, and other screens around the tasks users need to complete. Each part of the interface is organized to help users find information and complete actions without unnecessary steps."
      },
      {
        "title": "Mobile App Design",
        "desc": "Our mobile app design services cover screen layouts, navigation, user flows, buttons, forms, and touch-based interactions. We consider the smaller screen size and how users interact with the app on mobile devices. We can design a new mobile application or improve an existing app where users face navigation or usability problems.",
        "q": "Mobile App Design",
        "a": "Our mobile app design services cover screen layouts, navigation, user flows, buttons, forms, and touch-based interactions. We consider the smaller screen size and how users interact with the app on mobile devices. We can design a new mobile application or improve an existing app where users face navigation or usability problems."
      },
      {
        "title": "Design Systems",
        "desc": "We create reusable design components, styles, and patterns for your product. A design system gives designers and developers a shared set of rules for creating consistent screens and features. It also makes future design work easier when your product needs new screens or updates.",
        "q": "Design Systems",
        "a": "We create reusable design components, styles, and patterns for your product. A design system gives designers and developers a shared set of rules for creating consistent screens and features. It also makes future design work easier when your product needs new screens or updates."
      },
      {
        "title": "Prototyping",
        "desc": "We create clickable prototypes to show how users will move through your product. Prototypes can cover a single feature, a group of screens, or a complete user flow. You can review the proposed experience before development starts and make changes before the final design is handed over.",
        "q": "Prototyping",
        "a": "We create clickable prototypes to show how users will move through your product. Prototypes can cover a single feature, a group of screens, or a complete user flow. You can review the proposed experience before development starts and make changes before the final design is handed over."
      }
    ],
    "whyChooseItems": [
      {
        "title": "Quality-Focused Design",
        "desc": "We focus on clear layouts, simple navigation, consistent interfaces, and practical user flows. Each screen has a clear purpose and supports the tasks users need to complete.",
        "q": "Quality-Focused Design",
        "a": "We focus on clear layouts, simple navigation, consistent interfaces, and practical user flows. Each screen has a clear purpose and supports the tasks users need to complete."
      },
      {
        "title": "Planned Delivery",
        "desc": "We divide the work into clear stages so you can review progress throughout the project. If requirements change, we discuss the effect on the design scope and delivery plan before moving forward.",
        "q": "Planned Delivery",
        "a": "We divide the work into clear stages so you can review progress throughout the project. If requirements change, we discuss the effect on the design scope and delivery plan before moving forward."
      },
      {
        "title": "Transparent Communication",
        "desc": "You receive clear updates on completed work, current tasks, upcoming steps, and any issues that need your input. Regular communication keeps the project aligned with your requirements.",
        "q": "Transparent Communication",
        "a": "You receive clear updates on completed work, current tasks, upcoming steps, and any issues that need your input. Regular communication keeps the project aligned with your requirements."
      },
      {
        "title": "Ongoing Design Support",
        "desc": "Your design needs can change as your product grows. We can support new features, additional screens, design updates, and changes to your existing design system after the initial project.",
        "q": "Ongoing Design Support",
        "a": "Your design needs can change as your product grows. We can support new features, additional screens, design updates, and changes to your existing design system after the initial project."
      }
    ],
    "ctaPrimaryText": "Start a Project",
    "ctaSecondaryText": "Get a Free Estimate",
    ...
    "challenges": [
      {
        ...
        "body": "Applications scatter across inboxes and job boards."
      },
      {
        "title": "Inconsistent process",
        "body": "Every recruiter runs a different pipeline."
      },
      {
        "title": "Weak decisions",
        "body": "Hiring managers lack structured feedback and history."
      }
    ],
    "steps": [
      {
        "title": "Intake roles",
        "body": "Structured requisitions with scorecards."
      },
      {
        "title": "Source & screen",
        "body": "Central applications and collaborative notes."
      },
      {
        "title": "Interview loops",
        "body": "Schedules, feedback, and stage gates."
      },
      {
        "title": "Offer & onboard",
        "body": "Clean handoff to HR with full history."
      }
    ],
    "answers": []
  },
    ...
    "challenges": [
      {
        ...
        "body": "Important updates get buried in group chats."
      },
      {
        "title": "Fragmented channels",
        "body": "SMS, email, and paper notices never stay in sync."
      },
      {
        "title": "Trust & privacy",
        "body": "Schools need controlled, auditable communication."
      }
    ],
    "answers": [
      {
        "title": "One inbox",
        "body": "Announcements, class updates, and alerts in a single app experience."
      },
      {
        "title": "Role-based access",
        "body": "Teachers, admin, and parents see only what they should."
      },
      {
        "title": "Attendance-friendly",
        "body": "Works alongside how schools already operate day to day."
      }
    ],
    "steps": [
      {
        "title": "Onboard school",
        "body": "Classes, roles, and parent links."
      },
      {
        "title": "Broadcast clearly",
        "body": "Targeted announcements with read signals."
      },
      {
        "title": "Message safely",
        "body": "Threaded, moderated conversations."
      },
      {
        "title": "Stay aligned",
    ...
    "productsBuilt": [
      {
        "name": "Schoolgram",
        "slug": "schoolgram",
        "blurb": "School communication suite for parents, teachers, and admin."
      },
      {
        "name": "Image to Text",
        "slug": "image-to-text",
        "blurb": "OCR for worksheets, notes, and scanned materials."
      },
      {
        "name": "JPG to PDF",
        "slug": "jpg-to-pdf",
        "blurb": "Bundle scans and images into shareable PDFs."
      }
    ],
    "caseStudies": [
      {
...
const initialProjects = [
  ...
  },
  {
    ...
    "desc": "AI-powered analytics platform that transforms data into actionable business insights.",
    "tag": "AI Solutions",
...
const initialFaqs = [
  ...
  {
    "q": "Does Cubixsol work with both startups and established businesses?",
    "a": "Yes. We help early-stage founders validate and launch new products while supporting growing and established businesses with complex platforms, modernization, integrations, automation, and additional development capacity.",
    "category": "General"
  },
  {
  ...
  },
  {
    ...
    "a": "MVP cost depends on the number of features, product complexity, platforms, integrations, design requirements, and delivery schedule. After a discovery discussion, we provide a clear estimate based on the essential features required to validate your product.",
    "category": "General"
  },
  {
...
const initialTestimonials = [
  {
    "quote": "Dedicated development team transformed our initial concept into a stable, market-ready product. The team communicated clearly, responded quickly to feedback, and completed each milestone according to the agreed schedule.",
    "name": "Michael Carter",
    "role": " Founder"
  },
  {
    "quote": "The expert team handled the project with technical care and attention to detail. The final platform simplified our daily operations and created a much better experience for our users.",
    "name": "Emily Reynolds",
    "role": "Operations Director"
  },
  {
    "quote": "Cubixsol integrated smoothly with our internal team and provided the technical expertise we needed. They maintained strong code quality, kept the project within scope, and continued to support us after launch.",
    "name": "Daniel Brooks",
...
const initialAuthors = [
  {
    "name": "Irfan Haider",
    "email": "arfanahaider575@gmail.com"
  }
];
